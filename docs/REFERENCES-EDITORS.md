...
| 19 | **Трекер + список фреймов/паттернов, mute/solo каналов, follow-режим** | полностью | **отсутствует целиком** | pattern navigator + flow-кнопки | LIKO‑12 здесь не образец; ориентир — TIC‑80/PICO‑8 |
